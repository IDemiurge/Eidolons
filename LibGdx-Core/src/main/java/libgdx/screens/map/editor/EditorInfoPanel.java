...
import libgdx.screens.map.editor.EditorControlPanel.MAP_EDITOR_MOUSE_MODE;
import libgdx.screens.map.editor.EditorInfoPanel.EditorInfoTab;
import libgdx.screens.map.editor.EditorPalette.EDITOR_PALETTE;
import libgdx.particles.EmitterActor;
