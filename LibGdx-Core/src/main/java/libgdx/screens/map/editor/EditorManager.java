...
import libgdx.screens.map.obj.MapActor;
...
public class EditorManager {
    static EditorControlPanel.MAP_EDITOR_MOUSE_MODE mode;
    ...
    public static void modify(boolean addOrRemove, int screenX, int screenY) {
        EditorControlPanel.MAP_EDITOR_MOUSE_MODE mode = EditorManager.getMode();
       /*
        ...
        */
        ...
        int y = (int) v.y;
        if (mode == null)
            mode = EditorControlPanel.MAP_EDITOR_MOUSE_MODE.ADD;
...
//        ga.getState().manager.removeTrigger(getTrigger());
    ...
    public static EditorControlPanel.MAP_EDITOR_MOUSE_MODE getMode() {
        return mode;
    }

    public static void setMode(EditorControlPanel.MAP_EDITOR_MOUSE_MODE mode) {
