...
public class ShardEnums {
    public static GenericEnums.ALPHA_TEMPLATE getTemplateForOverlay(VisualEnums.SHARD_OVERLAY overlay) {
        return GenericEnums.ALPHA_TEMPLATE.SHARD_OVERLAY;
    }

    public static GenericEnums.VFX[] getEmitters(VisualEnums.SHARD_OVERLAY overlay, VisualEnums.SHARD_SIZE size) {
    ...
    private static GenericEnums.VFX[] getEmittersForOverlay(VisualEnums.SHARD_OVERLAY overlay) {
        if (overlay == null) {
            overlay = new EnumMaster<VisualEnums.SHARD_OVERLAY>().
                    getRandomEnumConst(VisualEnums.SHARD_OVERLAY.class);
        }
        switch (overlay) {
            case MIST:
    ...
    public static String getBackgroundTexturePath(Object arg, DIRECTION direction, VisualEnums.SHARD_TYPE type, VisualEnums.SHARD_SIZE size) {
        String path;
        String name=null ;
        if (direction == null) {
            ...
            name = size == VisualEnums.SHARD_SIZE.SMALL
                    ? size + "up"
                    : size + "down";
    ...
    public static String getRandomForegroundTexturePath(Object arg, VisualEnums.SHARD_OVERLAY overlay) {
