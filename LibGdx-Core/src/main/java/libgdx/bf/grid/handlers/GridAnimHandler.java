...
public class GridAnimHandler extends GridHandler {
    ...
    protected void bindEvents() {
        for (VisualEnums.VIEW_ANIM value : VisualEnums.VIEW_ANIM.values()) {
        ...
        GuiEventManager.bind(ACTOR_SPEAKS, p -> {
            ...
            animate(view, VisualEnums.VIEW_ANIM.screen, data);
        ...
        GuiEventManager.bind(GuiEventType.GRID_OBJ_ANIM, p -> {
            ...
            if (list.get(1) instanceof Coordinates) {
                ...
                animate(getView((Obj) list.get(1)),
                        (VisualEnums.VIEW_ANIM) list.get(0), data);
            }
    ...
    protected void handleAnim(GroupX animated, VisualEnums.VIEW_ANIM value, Object o) {
    ...
    private GraphicData getDefaultData(VisualEnums.VIEW_ANIM value) {
        switch (value) {
            case displace:
    ...
    public void animate(BaseView view, VisualEnums.VIEW_ANIM value) {
        animate(view.getPortrait(), value, getDefaultData(value));
    }

    public boolean animate(GroupX animated, VisualEnums.VIEW_ANIM value, GraphicData data) {
