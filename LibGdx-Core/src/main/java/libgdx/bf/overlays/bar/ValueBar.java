...
public abstract class ValueBar extends SuperActor {
    ...
    protected FloatActionLimited primaryAction = (FloatActionLimited) ActionMasterGdx.getAction(FloatActionLimited.class);
    protected FloatActionLimited secondaryAction = (FloatActionLimited) ActionMasterGdx.getAction(FloatActionLimited.class);
