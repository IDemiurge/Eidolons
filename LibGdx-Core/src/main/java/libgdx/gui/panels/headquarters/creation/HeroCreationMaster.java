...
//TODO gdx sync - move back to DC!
    ...
    public static void modified(PROPERTY property, String value) {
        ...
        HqDataMaster.operation(model,
                HeroDataModel.HERO_OPERATION.SET_PROPERTY, property, value);
    ...
    public static void modified(PARAMETER parameter, String value) {
        HqDataMaster.operation(model,
                HeroDataModel.HERO_OPERATION.SET_PARAMETER, parameter, value);
    }
    ...
    public static void applyBackgroundType(Entity entity) {
        HqDataMaster.operation(model, HeroDataModel.HERO_OPERATION.APPLY_TYPE, entity);
        HqDataMaster.operation(model, HeroDataModel.HERO_OPERATION.LEVEL_UP, INITIAL_LEVEL);
    }
