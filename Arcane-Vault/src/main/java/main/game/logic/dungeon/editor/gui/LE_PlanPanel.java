...
public class LE_PlanPanel extends G_Panel {
	...
	public LE_PlanPanel() {
		...
		controlPanel = new ControlPanel<PLAN_CONTROLS>(PLAN_CONTROLS.class);
		blockControlPanel = new ControlPanel<BLOCK_CONTROLS>(BLOCK_CONTROLS.class);
		levelControlPanel = new ControlPanel<LEVEL_CONTROLS>(LEVEL_CONTROLS.class);
		missionControlPanel = new ControlPanel<MISSION_CONTROLS>(MISSION_CONTROLS.class);
		objControlPanel = new ControlPanel<OBJ_CONTROLS>(OBJ_CONTROLS.class);
