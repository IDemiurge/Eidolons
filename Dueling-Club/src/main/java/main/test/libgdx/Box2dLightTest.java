...
public class Box2dLightTest extends InputAdapter implements ApplicationListener {
    ...
    public void create() {
        ...
        textureRegion = new TextureRegion(new Texture(
                Gdx.files.internal(Box2dLightTest.class.getResource("/data/marble.png").getPath())));
        bg = new Texture(Gdx.files.internal(Box2dLightTest.class.getResource("/data/bg.png").getPath()));
