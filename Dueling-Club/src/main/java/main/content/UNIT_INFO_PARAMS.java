...
//      BASH_RESISTANCE,
    ...
    public static final PARAMS[] ACTION_TOOLTIP_PARAMS_RANGE_ROW_NAMES  = {
     CLOSE_QUARTERS_DAMAGE_MOD,
     DAMAGE_MOD,
     LONG_REACH_DAMAGE_MOD,
    };
    public static final PARAMS[] ACTION_TOOLTIP_PARAMS_RANGE = {
     CLOSE_QUARTERS_DAMAGE_MOD, CLOSE_QUARTERS_ATTACK_MOD,
     DAMAGE_MOD, ATTACK_MOD,
     LONG_REACH_DAMAGE_MOD, LONG_REACH_ATTACK_MOD,
    };
    public static final PARAMS[] ACTION_TOOLTIP_PARAMS_TEXT = {
     CRITICAL_MOD,
     ACCURACY,
     ARMOR_MOD,
     IMPACT_AREA,
