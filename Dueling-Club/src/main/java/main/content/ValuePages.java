...
//     FATIGUE, CONFUSION,
    ...
    public static final PARAMETER[] ACTION_TOOLTIP_PARAMS = {
     PARAMS.BASE_DAMAGE,
     PARAMS.DIE_SIZE,
     PARAMS.CRITICAL_MOD,
    ...
    public static final PARAMETER[] ACTION_TOOLTIP_PARAMS_EXTRA_ATTACKS = {
     PARAMS.COUNTER_MOD,
     PARAMS.INSTANT_ATTACK_MOD,
     PARAMS.AOO_ATTACK_MOD,

    };
    public static final PARAMETER[] ACTION_TOOLTIP_PARAMS_POSITION = {
     PARAMS.SIDE_DAMAGE_MOD,
     PARAMS.DIAGONAL_DAMAGE_MOD,
     PARAMS.SIDE_ATTACK_MOD,
     PARAMS.DIAGONAL_ATTACK_MOD,

     PARAMS.LONG_REACH_ATTACK_MOD,
     PARAMS.LONG_REACH_DAMAGE_MOD,
     PARAMS.CLOSE_QUARTERS_ATTACK_MOD,
     PARAMS.CLOSE_QUARTERS_DAMAGE_MOD,

    };
    public static final PARAMETER[] ACTION_TOOLTIP_PARAMS_MISC = {

     PARAMS.FORCE,
     PARAMS.BLEEDING_MOD,
     PARAMS.DURABILITY_DAMAGE_MOD,
     PARAMS.AUTO_CRIT_CHANCE,
     PARAMS.ACCURACY,
     PARAMS.SNEAK_DAMAGE_MOD,

    };
    public static final PARAMETER[] ACTION_TOOLTIP_PARAMS_ATTR_DMG_MODS = {
     PARAMS.STR_DMG_MODIFIER,
     PARAMS.AGI_DMG_MODIFIER,
     PARAMS.INT_DMG_MODIFIER,
     PARAMS.SP_DMG_MODIFIER,
    };
    public static final PARAMETER[] ACTION_TOOLTIP_PARAMS_COSTS = {
     PARAMS.AP_COST,
     PARAMS.CP_COST,
     PARAMS.STA_COST,
     PARAMS.FOC_REQ,
    ...
    public static final PARAMETER[][]  ACTION_TOOLTIP_PARAMS_FULL = {
     ACTION_TOOLTIP_PARAMS,
     ACTION_TOOLTIP_PARAMS_POSITION,
     ACTION_TOOLTIP_PARAMS_EXTRA_ATTACKS,
     ACTION_TOOLTIP_PARAMS_MISC,
     ACTION_TOOLTIP_PARAMS_ATTR_DMG_MODS,
     ACTION_TOOLTIP_PARAMS_COSTS
    };
