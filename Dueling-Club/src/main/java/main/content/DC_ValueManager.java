...
public class DC_ValueManager implements ValueManager {
    ...
    public enum VALUE_GROUP {
        ...
        WAR_MAGIC(SORCERY_MASTERY, WITCHERY_MASTERY, SAVAGE_MASTERY, DESTRUCTION_MASTERY),

        FORBIDDEN_ARTS(BLOOD_MAGIC_MASTERY, AFFLICTION_MASTERY, WARP_MASTERY, DEMONOLOGY_MASTERY, PSYCHIC_MASTERY),
