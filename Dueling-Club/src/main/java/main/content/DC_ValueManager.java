...
public class DC_ValueManager implements ValueManager {
    ...
    public PARAMETER[] ACTION_TOOLTIP_PARAMS = {
     PARAMS.BASE_DAMAGE,
     PARAMS.DIE_SIZE,
     PARAMS.CRITICAL_MOD,
    ...
    public PARAMETER[] ACTION_TOOLTIP_PARAMS_EXTRA_ATTACKS = {
     PARAMS.COUNTER_MOD,
     PARAMS.INSTANT_ATTACK_MOD,
     PARAMS.AOO_ATTACK_MOD,

    };
    public PARAMETER[] ACTION_TOOLTIP_PARAMS_POSITION = {
    ...
    public PARAMETER[] ACTION_TOOLTIP_PARAMS_MISC = {
    ...
    public PARAMETER[] ACTION_TOOLTIP_PARAMS_ATTR_DMG_MODS = {
