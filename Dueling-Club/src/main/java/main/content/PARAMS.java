...
import main.rules.mechanics.UnconsciousRule;
...
public enum PARAMS implements PARAMETER {
    ...
    TOUGHNESS(null, "", false, 0, "units", "chars", "bf obj", "skills"),
    C_TOUGHNESS(null, "", true, 0, "units", "chars", "bf obj"),
    ENDURANCE(null, "", false, 0, "units", "chars", "bf obj", "skills"),
    C_ENDURANCE(null, "", true, 0, "units", "chars", "bf obj"),
    MORALE(null, "MORALE", false, 30, "chars", "skills", "units"),
    C_MORALE(null, "", true, 30, "units", "chars"),
    STAMINA(null, "STAMINA", false, 5, "chars", "skills", "units"),
    C_STAMINA(null, "STAMINA", true, 5, "chars", "skills", "units"),
    FOCUS(null, "FOCUS", false, 100, "chars", "skills", "units"),
    C_FOCUS(null, "FOCUS", true, 0, "chars", "skills", "units"),
    ESSENCE(null, "ESSENCE", false, 0, "chars", "skills", "units"),
    C_ESSENCE(null, "ESSENCE", true, 0, "chars", "skills", "units"),
    ...
    STRENGTH(null, Descriptions.Strength, false, 0, "chars", "units", "jewelry", "skills", "classes"),
    ...
    STAMINA_REGEN("Sta. Regen", "STAMINA_REGEN", true, 0, "chars", "skills", "units"),
    ESSENCE_REGEN("Ess. Regen", "ESSENCE_REGEN", false, 0, "chars", "skills", "units"),
    FOCUS_REGEN(null, "FOCUS_REGEN", false, 0, "chars", "skills", "units"),
    STARTING_FOCUS("Start foc", "FOCUS", false, 0, "chars", "skills", "units"),
    BASE_FOCUS("Base focus", "FOCUS", false, 0, "chars", "skills", "units"),
    BASE_DAMAGE("Base Damage", "", false, 0, "units", "chars", "skills"),
    ...
    // ARMOR("Armor", "", false, 0, "units", "chars", "skills", "bf obj",
    // "armor"), see last, quick fixer -> ok I don't remember why I did it...
    ARMOR("Armor", "", false, 0, "units", "chars", "skills", "bf obj", "armor"),
    ...
    SPIRIT(null, "", false, 3, "units", "chars", "skills"),
    FORTITUDE(null, "", false, 5, "units", "chars", "skills"),

    ENDURANCE_REGEN("End. Regen.", "", false, 0, "units", "chars", "bf obj", "skills"), // Color.GREEN.brighter()),
    SPELL_ARMOR(null, "", false, 0, "units", "armor", "chars", "skills", "bf obj"),
    RESISTANCE(null, "", false, 0, "units", "chars", "skills", "bf obj"),
    DEFENSE("Defense", "", false, 0, "units", "chars", "skills", "bf obj"),
    ATTACK("Attack", "", false, 0, "units", "chars", "skills", "bf obj"),
    OFF_HAND_ATTACK("Offh. ATK", "", false, 0, "units", "chars"),
    DEFENSE_PENETRATION("Def. Pntr", "", false, 0, "chars", "skills"),
    RESISTANCE_PENETRATION("Res. Pntr", "", false, 0, "actions", "units", "chars", "skills"),
    ARMOR_PENETRATION("Armor Pntr", "", false, 0, "actions", "units", "chars", "skills", "weapons"),
    ARMOR_MOD(true, "Armor Pntr %", "", false, 100, "actions", "units", "chars", "skills", "weapons"),
    ...
    INITIATIVE_MODIFIER("Initiative mod", "", false, 10, "units", "chars", "skills", "bf obj"),
    INITIATIVE_BONUS("Initiative bonus", "", false, 5, "units", "chars", "skills", "bf obj"),
    ...
    DETECTION(null, "DETECTION", false, 10, "bf obj", "units", "chars", "armor", "skills"),
    STEALTH(null, "STEALTH", false, 0, "bf obj", "units", "chars", "armor", "skills"),
    CONCEALMENT(null, null, false, 0, "terrain", "bf obj", "units", "chars", "armor", "skills"),
    ILLUMINATION(null, null, false, 0, "terrain", "bf obj", "units", "chars", "armor", "skills", "classes"),
    LIGHT_EMISSION(null, null, false, 0, "terrain", "bf obj", "units", "chars", "armor", "skills", "classes"),
    ...
    REVEALMENT(null, null, false, 0, "action", "spell", "bf obj", "units", "chars", "armor", "skills"),

    SIGHT_RANGE(null, "Sight Range", false, 0, "bf obj", "units", "chars", "skills", "armor"),
    BEHIND_SIGHT_BONUS("Behind Sight", "BEHIND_SIGHT_BONUS", false, 0, "bf obj", "units", "chars", "skills"),
    SIDE_SIGHT_PENALTY("Sidesight pen.", "SIDE_SIGHT_PENALTY", false, 0, "bf obj", "units", "chars", "skills", "armor"),
    // buff
    ...
    LIGHT_RESISTANCE("Light", "", false, 0, "units", "chars", "bf obj", "armor", "skills"),
    SONIC_RESISTANCE("Sonic", "", false, 0, "units", "chars", "bf obj", "armor", "skills"), // gust
    // of
    // wind
    // -
    // physical?
    ...
    CHAOS_RESISTANCE("Chaos", "", false, 0, "units", "chars", "bf obj", "armor", "skills"),
    HOLY_RESISTANCE("Holy", "", false, 0, "units", "chars", "bf obj", "armor", "skills"),
    SHADOW_RESISTANCE("Shadow", "", false, 0, "units", "chars", "bf obj", "armor", "skills"),
    ARCANE_RESISTANCE("Arcane", "", false, 0, "units", "chars", "bf obj", "armor", "skills"),
    POISON_RESISTANCE("Poison", "", false, 0, "units", "chars", "bf obj", "armor", "skills"),
    DEATH_RESISTANCE("Death", "", false, 0, "units", "chars", "bf obj", "armor", "skills"),
    PSIONIC_RESISTANCE("Psionic", "", false, 0, "units", "chars", "bf obj", "armor", "skills"),
    ...
    REST_BONUS(null, "", false, 0, "units", "chars", "skills", "classes"),
    MEDITATION_BONUS(null, "", false, 0, "units", "chars", "skills", "classes"),
    CONCENTRATION_BONUS("", "", false, 0, "units", "chars", "skills", "classes"),
    REST_MOD(true, null, "", false, 0, "units", "chars", "skills", "classes"),
    MEDITATION_MOD(true, null, "", false, 0, "units", "chars", "skills", "classes"),
    CONCENTRATION_MOD(true, "", "", false, 0, "units", "chars", "skills", "classes"),
    ...
    TACTICS_MASTERY(null, "Mastery", false, 0, "units", "chars", "classes", "skills"),
    LEADERSHIP_MASTERY(null, "Mastery", false, 0, "units", "chars", "classes", "skills"),

    MARKSMANSHIP_MASTERY(null, "Mastery", false, 0, "units", "chars", "classes", "skills"),
    ITEM_MASTERY(null, "Mastery", false, 0, "units", "chars", "classes", "skills"),

    ATHLETICS_MASTERY(null, "Mastery", false, 0, "units", "chars", "classes", "skills"),
    MOBILITY_MASTERY(null, "Mastery", false, 0, "units", "chars", "classes", "skills"),

    BLADE_MASTERY(null, "Mastery", false, 0, "units", "chars", "classes", "skills"),
    BLUNT_MASTERY(null, "Mastery", false, 0, "units", "chars", "classes", "skills"),
    AXE_MASTERY(null, "Mastery", false, 0, "units", "chars", "classes", "skills"),
    POLEARM_MASTERY(null, "Mastery", false, 0, "units", "chars", "classes", "skills"),
    UNARMED_MASTERY(null, "Mastery", false, 0, "units", "chars", "classes", "skills"),

    TWO_HANDED_MASTERY(null, "Mastery", false, 0, "units", "chars", "classes", "skills"),

    DUAL_WIELDING_MASTERY(null, "Mastery", false, 0, "units", "chars", "classes", "skills"),

    ARMORER_MASTERY(null, "Mastery", false, 0, "units", "chars", "classes", "skills"),
    DEFENSE_MASTERY(null, "Mastery", false, 0, "units", "chars", "classes", "skills"),
    SHIELD_MASTERY(null, "Mastery", false, 0, "units", "chars", "classes", "skills"),

    MEDITATION_MASTERY(null, Descriptions.MEDITATION_MASTERY, false, 0, "units", "chars", "classes", "skills"),
    DISCIPLINE_MASTERY(null, "Mastery", false, 0, "units", "chars", "classes", "skills"),
    // MAGICAL_ITEM_MASTERY(null, "Mastery", false, 0, "units", "chars",
    // "classes"),

    WIZARDRY_MASTERY(null, "Mastery", false, 0, "units", "chars", "classes", "skills"),
    SPELLCRAFT_MASTERY(null, "Mastery", false, 0, "units", "chars", "classes", "skills"),
    DIVINATION_MASTERY(null, Descriptions.DIVINATION_MASTERY, false, 0, "units", "chars", "classes", "skills"),
    WARCRY_MASTERY(null, "Mastery", false, 0, "units", "chars", "classes", "skills"),
    // spellgroups
    PSYCHIC_MASTERY(null, "Mastery", false, 0, "units", "chars", "classes", "skills"),

    REDEMPTION_MASTERY(null, "Mastery", false, 0, "units", "chars", "classes"),

    SORCERY_MASTERY(null, "Mastery", false, 0, "units", "chars", "classes", "skills"),
    // ANTI_MAGIC_MASTERY(null, "Mastery", false, 0, "units", "chars",
    // "classes"),
    ENCHANTMENT_MASTERY(null, "Mastery", false, 0, "units", "chars", "classes", "skills"),
    // TRANSMUTATION_MASTERY(null, "Mastery", false, 0, "units", "chars",
    // "classes"),
    CONJURATION_MASTERY(null, "Mastery", false, 0, "units", "chars", "classes", "skills"),
    ...
    DESTRUCTION_MASTERY(null, "Mastery", false, 0, "units", "chars", "classes", "skills"),
    AFFLICTION_MASTERY(null, "Mastery", false, 0, "units", "chars", "classes", "skills"),
    BLOOD_MAGIC_MASTERY(null, "Mastery", false, 0, "units", "chars", "classes", "skills"),

    WITCHERY_MASTERY(null, "Mastery", false, 0, "units", "chars", "classes", "skills"),
    SHADOW_MASTERY(null, "Mastery", false, 0, "units", "chars", "classes", "skills"),

    NECROMANCY_MASTERY(null, "Mastery", false, 0, "units", "chars", "classes"),

    VOID_MASTERY(null, "Mastery", false, 0, "units", "chars", "classes"),
    DETECTION_MASTERY(null, "Mastery", false, 0, "units", "chars", "classes", "skills"),
    STEALTH_MASTERY(null, "Mastery", false, 0, "units", "chars", "classes", "skills"),

    SAVAGE_MASTERY(null, "Mastery", false, 0, "units", "chars", "classes"),

    XP_GAIN_MOD(true, null, "Experience points", false, 100, "chars", "units", "skills"),
    XP_LEVEL_MOD(true, null, "Experience points", false, 100, "chars", "units", "skills"),
    ...
    XP_COST_REDUCTION("Experience", "Experience cost", false, 0, "chars", "units", "skills"),
    XP_COST_REDUCTION_VERBATIM_SPELLS("Experience", "Experience cost", false, 0, "chars", "units", "skills"),
    XP_COST_REDUCTION_LEARNED_SPELLS("Experience", "Experience cost", false, 0, "chars", "units", "skills"),
    ...
    SNEAK_ATTACK_MOD(true, null, " ATTACK_MOD", false, 125, "actions", "chars", "units"),
    SNEAK_DEFENSE_MOD(true, null, " DEFENSE_MOD", false, 50, "actions", "chars", "units"),
