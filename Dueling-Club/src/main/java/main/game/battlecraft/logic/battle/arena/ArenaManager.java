...
import main.game.battlecraft.logic.battle.Battle.BATTLE_STATS;
...
public class ArenaManager {
    ...
    private ArenaBattleConstructor constructor;
...
//                    (DEFAULT_BACKGROUND != null) ? DEFAULT_BACKGROUND : getRandomBackground());
    ...
    public void init() {
        ...
        setConstructor(new ArenaBattleConstructor(this));
...
//            this.map = new DungeonMapGenerator().generateMap(game.getDungeonMaster().getDungeon());
    ...
    public ArenaBattleConstructor getBattleConstructor() {
        return constructor;
    }

    public void setConstructor(ArenaBattleConstructor constructor) {
