...
public class MainParamPanel extends TablePanel {
    ...
    public void act(float delta) {
        ...
        if (updatePanel) {
            UnitInfoMainParamSource source = (UnitInfoMainParamSource) getUserObject();
