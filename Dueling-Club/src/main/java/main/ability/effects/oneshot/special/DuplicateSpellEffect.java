...
public class DuplicateSpellEffect extends MicroEffect {
    ...
    DuplicateSpellEffect(String target_key, Boolean choosetarget, Boolean event) {
        this.target_key = target_key;
        this.chooseTarget = choosetarget;
        this.event = event;
    }

    DuplicateSpellEffect(String target_key, Boolean choosetarget) {
