...
import eidolons.game.battlecraft.logic.meta.custom.QuestDungeonData;
import eidolons.game.battlecraft.logic.meta.custom.model.*;
...
import static eidolons.game.battlecraft.logic.meta.custom.QD_Enums.*;
...
public class QD_Assembler {
    ...
    public QD_Model assemble(QuestDungeonData data, long seed) {
        ...
        String preset = data.getValue(DungeonProperty.preset_floors);
    ...
    private QD_Module pickModule(int i, int max, DataUnit<FloorProperty> data, int attempt) {
        ...
        QD_Picker picker = new QD_Picker(i, max, attempt, previous, next, data);
