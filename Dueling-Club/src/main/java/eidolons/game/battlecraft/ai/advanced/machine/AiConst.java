...
//    RULE_ATTACK_OF_OPPORTUNITY,
    ...
    PARAM_DAMAGE_BONUS(2.5f), PARAM_DEFENSE(3), PARAM_ATTACK(3),PARAM_DEFENSE_MOD(2), PARAM_ATTACK_MOD(2),
    PARAM_DAMAGE_MOD(2.5f),  PARAM_STAMINA(12), PARAM_FOCUS(9), PARAM_MORALE(5),
