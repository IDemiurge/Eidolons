...
public class HeroWrapper extends HeroDataModel {
    ...
    public FACING_DIRECTION getFacingOrNull() {
        return getHero().getFacingOrNull();
    }
    ...
    public FACING_DIRECTION getFacing() {
        return getHero().getFacing();
    }

    @Override
    public void setFacing(FACING_DIRECTION facing) {
        getHero().setFacing(facing);
    }
    ...
    public FACING_DIRECTION getLastSeenFacing() {
        return getHero().getLastSeenFacing();
    }

    @Override
    public void setLastSeenFacing(FACING_DIRECTION lastSeenFacing) {
        getHero().setLastSeenFacing(lastSeenFacing);
    }
    ...
    public MACRO_MODES getMacroMode() {
        return getHero().getMacroMode();
    }

    @Override
    public void setMacroMode(MACRO_MODES mode) {
        getHero().setMacroMode(mode);
    }
    ...
    public int getSightRangeTowards(DC_Obj target) {
        return getHero().getSightRangeTowards(target);
    }

    @Override
    public int getSightRangeTowards(Coordinates coordinates) {
        return getHero().getSightRangeTowards(coordinates);
    }
