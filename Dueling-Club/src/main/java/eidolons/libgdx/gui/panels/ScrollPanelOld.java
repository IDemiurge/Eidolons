 ...
 */
public class ScrollPanelOld <T extends Actor> extends Container {
    ...
    public void setVisible(boolean visible) {
        ...
        if (visible) {
            getStage().setScrollFocus(ScrollPanelOld.this);
        }
    }

    protected void pad(ScrollPanelOld<T> tScrollPanel) {
    }
    ...
    public void initScrollListener() {
        ...
        addCaptureListener(new InputListener() {
            ...
            public void exit(InputEvent event, float x, float y, int pointer, Actor toActor) {
                if (getStage() != null) {
                    if (toActor != ScrollPanelOld.this)
                        if (!GdxMaster.getAncestors(toActor).contains(ScrollPanelOld.this))
