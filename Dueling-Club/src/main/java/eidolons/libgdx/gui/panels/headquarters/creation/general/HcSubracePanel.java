...
public class HcSubracePanel extends SelectionImageTable {
    ...
    protected SelectableItemData[] initDataArray() {
        ...
        for (BACKGROUND sub : subraces) {
            ...
            String name = StringMaster.getWellFormattedString(sub.name().replace("MAN_OF", ""));
            if (entity==null )
                continue;
            ...
            filtered.add(new SelectableItemData(name, description,previewImagePath, imagePath));
