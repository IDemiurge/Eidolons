...
public class SmartTextButton extends TextButton implements SmartButton {
    ...
    public SmartTextButton(String text, STD_BUTTON button, Runnable runnable) {
        this(text, button, runnable,
                StringMaster.isEmpty(text) ? null : DEFAULT_FONT, 20, GdxColorMaster.PALE_GOLD);
    }

    public SmartTextButton(STD_BUTTON button, Runnable runnable) {
    ...
    public SmartTextButton(String text, TextButtonStyle style, Runnable runnable, STD_BUTTON btnStyle) {
    ...
    public SmartTextButton(STD_BUTTON button) {
        this("", button, null);
    }
