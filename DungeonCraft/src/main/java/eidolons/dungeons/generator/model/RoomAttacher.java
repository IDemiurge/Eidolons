...
public class RoomAttacher {
    ...
    public Room findFitting(Coordinates entranceCoordinates, GeneratorEnums.EXIT_TEMPLATE roomExitTemplate,
        ...
        while (true) {
            ...
            if (roomModel == null) {
                //                templateMaster.resetSizedRandomRoomPools(zone.getTemplateGroup());
                //                continue;
                if (roomExitTemplate == GeneratorEnums.EXIT_TEMPLATE.CROSSROAD)
                    break;
                else return findFitting(entranceCoordinates, GeneratorEnums.EXIT_TEMPLATE.CROSSROAD, roomType, parentExit, zone);
            }
