...
public class ValuePages {
    ...
    public static final VALUE[] ADDITIONAL = {HERO_LEVEL,
            GOLD, FREE_MASTERIES, ATTR_POINTS, MASTERY_POINTS, GOLD_MOD,
    }; // everything
    ...
    public static final VALUE[] SPELL_VALUES = {
            ...
            FORCE_DAMAGE_MOD, FORCE_KNOCK_MOD, FORCE_PUSH_MOD,
    ...
    public static final VALUE[] SKILL_PARAMETERS = {CIRCLE, SKILL_DIFFICULTY,
            RANK_MAX, RANK_FORMULA_MOD, RANK_REQUIREMENT,
    ...
    public static final VALUE[] SKILL_ADDITIONAL = {
            ...
            PROPS.ATTRIBUTE_BONUSES, PROPS.PARAMETER_BONUSES, RANK_MAX, RANK_FORMULA_MOD, RANK_REQUIREMENT,
