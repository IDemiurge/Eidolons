...
public class AttributeConsts {
    ...
    public static final float AGI_REFLEX_BONUS = 0.1f;
    ...
    public static final float DEX_REFLEX_BONUS = 0.1f;
    ...
    public static final float WIS_SPIRIT_BONUS = 0.1f;
    public static final float B25_WIS_ELEMENTAL_RES = 1;
    public static final float A25_WIS_DETECTION = 1;

    public static final float CHA_SPIRIT_BONUS = 0.1f;
