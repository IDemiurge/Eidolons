...
//        return getHero().isPlayerCharacter();
    ...
    protected void cacheSimItems() {
        ...
        cacheSimItemContainer(hero.getJewelry(), getJewelry());
         ...
         SimCache.getInstance().addSim(hero.getWeapon(true), hero.getWeapon(true));
        SimCache.getInstance().addSim(hero.getWeapon(false), hero.getWeapon(false));
        SimCache.getInstance().addSim(hero.getNaturalWeapon(true), hero.getNaturalWeapon(true));
        SimCache.getInstance().addSim(hero.getNaturalWeapon(false), hero.getNaturalWeapon(false));
