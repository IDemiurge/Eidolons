package eidolons.game.netherflame.main.soul.eidola;
...
public class SoulMaster {
    ...
    public static void consume(Soul soul) {
        float force = SoulforceMaster.getForce(soul.getUnitType());
//        GuiEventManager.trigger(GuiEventType. VFX_PLAY_LAST)
        EidolonLord.lord.addParam(PARAMS.SOULFORCE, (int) force);
