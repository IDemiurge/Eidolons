...
import eidolons.game.exploration.dungeons.generator.pregeneration.PregeneratorData.PREGENERATOR_VALUES;
...
public class PregeneratorData extends DataUnit<PREGENERATOR_VALUES> {
    ...
    public enum PREGENERATOR_VALUES implements Options.OPTION {
        MAX_ATTEMPTS_PER_LEVEL(150, 1, 200),
        MAX_TIME,
        MIN_RATING(270, -100, 1000),
        GLOBAL_RANDOMNESS,
        LEVELS_REQUIRED(2, 1, 100),
