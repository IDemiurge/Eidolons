 ...
 */
public class RngXmlMaster {
    public static final String UNITS_NODE = "UNITS";
    public static final String AI_GROUPS_NODE = "AI_GROUPS";
    ...
    public static final String DIRECTION_MAP_NODE_OLD ="Direction_Map" ;
