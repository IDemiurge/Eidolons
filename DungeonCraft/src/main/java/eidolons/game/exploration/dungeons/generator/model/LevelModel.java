...
import eidolons.game.exploration.dungeons.generator.LevelGenerator;
import eidolons.game.exploration.dungeons.generator.graph.LevelGraph;
...
public class LevelModel {
    GeneratorEnums.ROOM_CELL[][] cells; //enum?
    ...
    private Map<Coordinates, GeneratorEnums.ROOM_CELL> additionalCells = new XLinkedMap<>();
    ...
    public GeneratorEnums.ROOM_CELL[][] getCells() {
        return cells;
    }

    public void setCells(GeneratorEnums.ROOM_CELL[][] cells) {
        this.cells = cells;
    }
    ...
    public void placeCell(Coordinates coordinates, LevelBlock block, GeneratorEnums.ROOM_CELL filler) {
        ...
        if (room.getCells()[relative .x]
         [relative.y].equals(GeneratorEnums.ROOM_CELL.EXIT.getSymbol()))
            return;
        if (room.getCells()[relative .x]
         [relative.y].equals(GeneratorEnums.ROOM_CELL.ENTRANCE.getSymbol()))
            return;
    ...
    public Map<Coordinates, GeneratorEnums.ROOM_CELL> getAdditionalCells() {
        return additionalCells;
    }

    public void setAdditionalCells(Map<Coordinates, GeneratorEnums.ROOM_CELL> additionalCells) {
