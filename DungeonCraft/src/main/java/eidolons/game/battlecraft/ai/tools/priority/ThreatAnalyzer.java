...
import eidolons.content.consts.VisualEnums.THREAT_LEVEL;
...
public class ThreatAnalyzer extends AiHandler {
    ...
    public static THREAT_LEVEL getThreatLevel(BattleFieldObject object) {
    ...
    // public static THREAT_LEVEL getThreatLevel(MacroParty party, MacroParty playerParty) {
    ...
    public static THREAT_LEVEL getThreatLevel(int percentage) {
