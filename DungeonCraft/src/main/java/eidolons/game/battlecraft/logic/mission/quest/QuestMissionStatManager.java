 ...
 */
public class QuestMissionStatManager extends MissionStatManager<QuestMission> {
    public QuestMissionStatManager(QuestMissionMaster questMissionMaster) {
        super(questMissionMaster);
    }
