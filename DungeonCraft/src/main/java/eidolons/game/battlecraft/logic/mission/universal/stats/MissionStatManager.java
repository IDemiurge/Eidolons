...
import eidolons.game.battlecraft.logic.mission.universal.DungeonSequence;
 ...
 * Usability stats!
 */
public class MissionStatManager<E extends DungeonSequence> extends MissionHandler<E> implements StatMaster {
    protected BattleStats stats;

    public MissionStatManager(MissionMaster master) {
        super(master);
        initializeBattle();
    }
