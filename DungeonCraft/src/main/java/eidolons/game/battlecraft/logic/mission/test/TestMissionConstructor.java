 ...
 */
public class TestMissionConstructor extends MissionConstructor<TestMission> {
    public TestMissionConstructor(MissionMaster<TestMission> master) {
        super(master);
    }
    ...
    @Override
    public TestMissionMaster getMaster() {
        return (TestMissionMaster) super.getMaster();
    }
}
