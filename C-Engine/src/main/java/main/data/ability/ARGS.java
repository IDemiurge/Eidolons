...
public enum ARGS implements Argument {
    ...
    STD_COUNTERS(STD_COUNTERS.class, AE_ELEMENT_TYPE.ENUM_CHOOSING),
    STANDARD_PASSIVES(STANDARD_PASSIVES.class, AE_ELEMENT_TYPE.ENUM_CHOOSING),

    MODVAL_TYPE(MOD.class, AE_ELEMENT_TYPE.ENUM_CHOOSING),
    DAMAGE_TYPE(DAMAGE_TYPE.class, AE_ELEMENT_TYPE.ENUM_CHOOSING),
    STATUS(STATUS.class, AE_ELEMENT_TYPE.ENUM_CHOOSING),
    ...
    TARGETING_MODE(TARGETING_MODE.class, AE_ELEMENT_TYPE.ENUM_CHOOSING),
    EFFECTS_WRAP(EFFECTS_WRAP.class, AE_ELEMENT_TYPE.ENUM_CHOOSING),
    CLASSIFICATIONS(CLASSIFICATIONS.class, AE_ELEMENT_TYPE.ENUM_CHOOSING),
    ...
    TARGETING_MODIFIERS(TARGETING_MODIFIERS.class, AE_ELEMENT_TYPE.ENUM_CHOOSING),
    MATERIAL(MATERIAL.class, AE_ELEMENT_TYPE.ENUM_CHOOSING),
    UNIT_TO_UNIT_VISION(UNIT_TO_UNIT_VISION.class, AE_ELEMENT_TYPE.ENUM_CHOOSING),
    UNIT_TO_PLAYER_VISION(UNIT_TO_PLAYER_VISION.class, AE_ELEMENT_TYPE.ENUM_CHOOSING),
    DAMAGE_MODIFIER(DAMAGE_MODIFIER.class, AE_ELEMENT_TYPE.ENUM_CHOOSING),
    OBJ_TYPES(main.content.OBJ_TYPES.class, AE_ELEMENT_TYPE.ENUM_CHOOSING),
    ...
    ROLL_TYPES(ROLL_TYPES.class, AE_ELEMENT_TYPE.ENUM_CHOOSING),
    ITEM_SLOT(ITEM_SLOT.class, AE_ELEMENT_TYPE.ENUM_CHOOSING),
