...
MACRO_OBJ_TYPES implements OBJ_TYPE {
    ...
    private OBJ_TYPES microType;

    MACRO_OBJ_TYPES(OBJ_TYPES TYPE, String name, Integer code) {
    ...
    public OBJ_TYPES getMicroType() {
        return microType;
    }

    public void setMicroType(OBJ_TYPES microType) {
