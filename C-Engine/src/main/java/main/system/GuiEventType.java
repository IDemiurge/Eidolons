...
public enum GuiEventType {
    ...
    GRID_OBJ_HOVER_OFF,
    SHOW_MODE_ICON,
    GAME_FINISHED, ADD_LIGHT, GAME_PAUSED, GAME_RESUMED, UPDATE_DIAGONAL_WALL_MAP, UPDATE_WALL_MAP, SHOW_CLEARSHOT, OPEN_DOOR, ITEM_TAKEN, UNIT_GREYED_OUT_ON, UNIT_GREYED_OUT_OFF,
}
