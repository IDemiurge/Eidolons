...
public enum GuiEventType implements EventType {
    ...
    SHOW_MANUAL_PANEL, SHOW_DIFFICULTY_SELECTION_PANEL, BLACKOUT_IN, BLACKOUT_OUT, BLACKOUT_AND_BACK,
    ...
    LOG_ROLLED_OUT, LOG_ROLLED_IN, SHOW_COMMENT_PORTRAIT, CAMERA_ZOOM, REMOVE_GRID_OBJ, WHITEOUT_AND_BACK, WHITEOUT_IN, WHITEOUT_OUT, PLAY_VIDEO, SET_PARTICLES_ALPHA, CAMERA_OFFSET, SET_SOUNDSCAPE_VOLUME, STOP_LOOPING_TRACK, ADD_LOOPING_TRACK, GRID_DISPLACE, GRID_SET_VIEW, GRID_SCREEN, GRID_COLOR, GRID_OBJ_ANIM, PORTAL_OPEN, PORTAL_CLOSE, GRID_ATTACHED, ACTOR_SPEAKS, TOGGLE_LOG_GL_PROFILER, DISPOSE_SCOPE, LOG_DIAGNOSTICS, HIGHLIGHT_ACTION, HIGHLIGHT_ACTION_OFF, SCALE_UP_VIEW, REMOVE_UNIT_VIEW, SOULS_CONSUMED, SOULS_CLAIMED, SHOW_LAST_COMMENT, SHOW_LAST_TUTORIAL_COMMENT, LOAD_SCOPE, STOP_LOOPING_TRACK_NOW, ADD_AMBI_VFX, CLEAR_COMMENTS, LE_CHOOSE_FILE,
