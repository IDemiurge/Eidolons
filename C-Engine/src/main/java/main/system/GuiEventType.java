...
public enum GuiEventType implements EventType {
    ...
    BATTLE_FINISHED, ATB_POS_PREVIEW, ACTION_HOVERED_OFF, ACTION_HOVERED, VALUE_MOD, PREVIEW_ATB_READINESS, TIME_PASSED, UPDATE_MAIN_HERO, NEW_ATB_TIME, UPDATE_LAST_SEEN_VIEWS, OPEN_OPTIONS, SHOW_HQ_SCREEN, SHOW_MASTERY_LEARN, UPDATE_INVENTORY_PANEL, INIT_AMBIENCE, GAME_RESET, SHOW_SKILL_CHOICE, SHOW_CLASS_CHOICE, SHOW_PERK_CHOICE, SHOW_INFO_TEXT, ACTION_BEING_ACTIVATED, CONFIRM, SHOW_VFX, SHOW_CUSTOM_VFX, PARRY, HC_PORTRAIT_CHOSEN, HC_GENDER_CHOSEN, HC_RACE_CHOSEN, HC_SUBRACE_CHOSEN, HC_SHOW, HC_DEITY_ASPECT_CHOSEN, HC_BACKGROUND_CHOSEN, SHOW_QUEST_SELECTION,
    QUEST_UPDATE,
    QUEST_ENDED,
    QUEST_STARTED,
    QUESTS_UPDATE_REQUIRED, SHOW_QUESTS_INFO, INTERACTIVE_OBJ_ON, INTERACTIVE_OBJ_OFF, DISPOSE_TEXTURES, SHOW_FULLSCREEN_ANIM, SHOW_TOWN_PANEL, QUEST_TAKEN, QUEST_CANCELLED, UPDATE_SHOP,
