...
public enum GuiEventType implements EventType {
    ...
    LOG_ROLLED_OUT, LOG_ROLLED_IN, SHOW_COMMENT_PORTRAIT, CAMERA_ZOOM, REMOVE_GRID_OBJ, WHITEOUT_AND_BACK, WHITEOUT_IN, WHITEOUT_OUT, PLAY_VIDEO, SET_PARTICLES_ALPHA, CAMERA_OFFSET, SET_SOUNDSCAPE_VOLUME, STOP_LOOPING_TRACK, ADD_LOOPING_TRACK,
