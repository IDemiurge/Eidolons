...
public enum GuiEventType implements EventType {
    ...
    QUEST_TAKEN, QUEST_CANCELLED, UPDATE_SHOP, SHOW_ACHIEVEMENTS, QUEST_COMPLETED, UNIT_VIEW_MOVED, HIDE_ALL_TEXT, HIDE_ACTION_INFO_TEXT, HIDE_INFO_TEXT, UNIT_VIEW_CREATED, SHOW_NAVIGATION_PANEL, BRIEFING_NEXT, BRIEFING_FINISHED, TIP_MESSAGE, BRIEFING_START,
