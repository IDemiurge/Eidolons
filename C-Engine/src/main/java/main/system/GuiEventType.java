...
public enum GuiEventType implements EventType {
    ...
    BATTLE_FINISHED, ATB_POS_PREVIEW, ACTION_HOVERED_OFF, ACTION_HOVERED, VALUE_MOD, PREVIEW_ATB_READINESS, TIME_PASSED, UPDATE_MAIN_HERO, NEW_ATB_TIME, UPDATE_LAST_SEEN_VIEWS, OPEN_OPTIONS, SHOW_HQ_SCREEN, SHOW_MASTERY_LEARN, UPDATE_INVENTORY_PANEL, INIT_AMBIENCE, GAME_RESET,
