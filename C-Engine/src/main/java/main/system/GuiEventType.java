...
public enum GuiEventType implements EventType {
    ...
    QUEST_ENDED,
    QUEST_STARTED,
    QUESTS_UPDATE_REQUIRED, SHOW_QUESTS_INFO, INTERACTIVE_OBJ_ON, INTERACTIVE_OBJ_OFF, DISPOSE_TEXTURES, SHOW_FULLSCREEN_ANIM, SHOW_TOWN_PANEL,
    ...
    BRIEFING_NEXT, BRIEFING_FINISHED, TIP_MESSAGE, BRIEFING_START, SHOW_SPRITE, CAMERA_PAN_TO_UNIT, POST_PROCESSING, POST_PROCESSING_RESET, QUICK_RADIAL, SHOW_SPRITE_SUPPLIER, POST_PROCESS_FX_ANIM, INIT_DIALOG, BOSS_ACTION, BOSS_CREATED, BOSS_VIEW_CREATED, CUSTOM_ANIMATION,
