...
//        main.system.auxiliary.log.LogMaster.dev("UNLOCKED " + o);
    ...
    public enum WAIT_OPERATIONS {
        ...
        FULLSCREEN_DONE, COMMENT_DONE, INPUT, FILE_SELECTION, DIALOG_SELECTION, DIALOG_SELECTION_CELL_SCRIPT_VALUE, DIALOG_SELECTION_ENUM, VISUAL_CHOICE, PLATFORM_EDIT_DONE, DATA_EDIT, WAIT_COMPLETE
    }
