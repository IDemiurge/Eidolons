...
public class WaitMaster {
    ...
    public static void unlock(Object o) {
        ...
        lock.unlock();
//        main.system.auxiliary.src.main.system.log.LogMaster.dev("UNLOCKED " + o);
    }
...
// if (getCompleteOperations().contains(operation))
// return true;
// main.system.auxiliary.LogMaster.src.main.system.log(LOG_CHANNELS.WAIT_DEBUG, " waiting for "
// + operation.toString());
// Waiter waiter = waiters.get(operation);
// boolean remove = true;
// Object result = null;
...
//
// LogMaster.src.main.system.log(LogMaster.WAIT_DEBUG, "INPUT RETURNED: " + result);
//
// if (remove) {
// waiters.remove(waiter);
// } else
// main.system.auxiliary.LogMaster.src.main.system.log(LogMaster.WAIT_DEBUG, "WAITER RETAINED: "
// + operation.toString());
//
// return result;
// }
...
// main.system.auxiliary.LogMaster.src.main.system.log(LOG_CHANNELS.WAIT_DEBUG,
// " received input for "
// + operation.toString() + ": " + input);
// Waiter waiter = waiters.get(operation);
// if (waiter == null) {
